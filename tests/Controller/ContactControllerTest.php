...
final class ContactControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'contact[position]' => 'Testing',
            'contact[phone]' => 'Testing',
            'contact[mobilePhone]' => 'Testing',
            'contact[address]' => 'Testing',
            'contact[customer]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setMobilePhone('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'contact[position]' => 'Something New',
            'contact[phone]' => 'Something New',
            'contact[mobilePhone]' => 'Something New',
            'contact[address]' => 'Something New',
            'contact[customer]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getMobilePhone());
